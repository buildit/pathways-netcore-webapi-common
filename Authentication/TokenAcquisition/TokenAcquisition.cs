namespace pathways_common.Authentication.TokenAcquisition
{
    using System;
    ...
    public class TokenAcquisition : ITokenAcquisition
    {
        ...
        public TokenAcquisition(IConfiguration configuration, IMSALAppTokenCacheProvider appTokenCacheProvider, IMSALUserTokenCacheProvider userTokenCacheProvider)
        {
            ...
            this._applicationOptions = new ConfidentialClientApplicationOptions();
            configuration.Bind("AzureAD", this._applicationOptions);
        ...
        private IConfidentialClientApplication BuildConfidentialClientApplication(HttpContext httpContext, ClaimsPrincipal claimsPrincipal)
        {
            ...
            var app = ConfidentialClientApplicationBuilder.CreateWithApplicationOptions(this._applicationOptions)
        ...
        private void AddAccountToCacheFromJwt(IEnumerable<string> scopes, JwtSecurityToken jwtToken, ClaimsPrincipal principal, HttpContext httpContext)
        {
            try
            {
                ...
                var application = this.BuildConfidentialClientApplication(httpContext, principal);
        ...
        public void ReplyForbiddenWithWwwAuthenticateHeader(HttpContext httpContext, IEnumerable<string> scopes, MsalUiRequiredException msalServiceException)
        {
            ...
            {
                if (TokenAcquisition.AcceptedTokenVersionIsNotTheSameAsTokenVersion(msalServiceException))
                {
            ...
            {
                { "clientId", this.azureAdOptions.ClientId },
